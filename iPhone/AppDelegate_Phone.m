...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {   
	...
	/* // used to read stored local variables on the phone, see also below in the commented applicatioWillTerminate method
...
*/
	...
	[temp_gameMenuViewController setTitle:@"The Game Menu View Controller"];
	
	
	// create the navigation controller
	UINavigationController *temp_navigationController = [[UINavigationController alloc] initWithRootViewController:temp_gameMenuViewController];
...
- (BOOL)application:(UIApplication *)application handleOpenURL:(NSURL *)url {
	NSLog(@"application handleOpenURL (iPhone)");
